...
domain = sc.utils.get_square_slice_from_one_anchor(
    torch.randn(1, in_shape), pad_dist=2, seed=None
)
...
NN = sc.wrappers.model_wrapper(model, input_shape=(in_shape,), T=T, dtype=torch.float64)
...
plt.savefig(
    "../figures/mlp_visualize.jpg", transparent=True, bbox_inches=0, pad_inches=0
)
